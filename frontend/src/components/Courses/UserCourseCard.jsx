...
const UserCourseCard = ({ course }) => {
  ...
  return (
    <div className="w-full sm:w-[280px] bg-white pt-7 md:pt-7 pb-4 px-4 shadow-lg rounded-xl flex flex-col items-center justify-center hover:scale-105 transition-transform">
      <div>
